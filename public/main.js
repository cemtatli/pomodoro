...
function updateClock() {
  ...
  const min = document.getElementById("minutesVal");
  const sec = document.getElementById("secondsVal");
...
const mainButton = document.getElementById("startButton");
  ...
  if ("Notification" in window && Notification.permission !== "denied") {
    Notification.requestPermission().then(function (permission) {
      if (permission === "granted") {
        new Notification("Excellent! You will receive notifications at the start of a pomodoro or when there is a break.");
      }
    });
  }

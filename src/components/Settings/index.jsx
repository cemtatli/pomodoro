  ...
  return (
    <div className="flex flex-col items-center justify-center w-full gap-4 ">
      <div className="w-full flex font-medium flex-col ">
        <h2 className="text-2xl font-bold flex items-center justify-center mb-2 gap-4">Settings</h2>
        <label className="w-full items-start capitalize my-2">
      ...
      <div className="w-full flex flex-col">
        <label className="w-full items-start capitalize font-medium my-2">
